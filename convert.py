...
def make_ch(chapter_title, image_paths, chapter_file_name):
    ...
    chapter_content = [
        ...
        "    <meta charset='utf-8' />",
        "    <style>",
        "      body { background-color: black; color: white; margin: 0; padding: 0; text-align: center; }",
        "      img { max-width: 100%; height: auto; margin: 10px auto; display: block; }",
        "      h1 { color: white; }",
        "      /* Force each image to appear on its own page */",
    ...
    chapter_content.append("<div style='height:50px;'></div>")
    chapter_content.append("  </body>")
